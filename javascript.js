...
// na linha 8 eu criei a funçao da propria função o usando o filter filtrando/ criando um novo array que passou sob as condições
// as palavras arma e droga(os itens não permitidos), o || ta verificando se tem os itens arma ou droga
